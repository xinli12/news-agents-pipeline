...
_MODE_CONFIGS: dict[str, AnalysisModeConfig] = {
    ...
    "deep": AnalysisModeConfig(
        mode="deep",
        label="Deep",
        description="Full-depth analysis with a larger source pool and extra audit passes",
        compact_downstream_context=False,
        downstream_article_limit=None,
        max_summary_chars=700,
        audit_revision_cycles=3,
        light_audit_revision_cycles=2,
        search_profile="deep",
        search_prompt_article_target="18-24",
        fast_optional_module_policy=False,
    ),
}
